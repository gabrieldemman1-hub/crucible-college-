...
async function main() {
  ...
  const whisperPrompt = (who, role, briefing) => [
    ...
    ``,
    `STEP 3, bridge. The moment ${who} says anything like "okay", "go ahead", "put them through", "send them over", "I'll take it", "connect us", or asks no further question for a few seconds, say "Connecting you now" and complete the transfer. If ${who} says they can't take the call, or asks you to try someone else, or hangs up, the transfer fails and you go back to the caller.`,
    ``,
