...
async function main() {
  ...
  const whisperPrompt = (who, role, briefing) => [
    ...
    `Speak this briefing in English, quickly and in one breath, under 8 seconds for a calm caller, filling in the details from the conversation so far:`,
